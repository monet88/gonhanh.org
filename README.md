...
- 🔄 **Tự động theo input source** — Chuyển sang bộ gõ khác (không phải ABC) → Gõ Nhanh tự tắt. Chuyển về ABC → tự bật lại
...
| Chuyển đổi input source | ⚠️ Phải tắt thủ công | ✅ Tự tắt/bật theo ABC |
